...
/// Pinhole camera. Holds the precomputed viewport basis (origin,
/// lower-left corner, horizontal/vertical edge vectors); rays are
/// generated by [`Self::ray_through`] for normalised image coordinates.
pub struct Camera {
    origin: Vec3,
    lower_left: Vec3,
    horizontal: Vec3,
